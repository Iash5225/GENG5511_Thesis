...
if __name__ == "__main__":
    ...
    if READ_FROM_EXCEL:
        ...
        ne_cell_volume_data = pd.concat(
            [ne_cell_volume_sub_data, ne_cell_volume_melt_data], ignore_index=True)
        xe_cell_volume_data = pd.concat(
            [xe_cell_volume_sub_data, xe_cell_volume_melt_data], ignore_index=True)
        kr_cell_volume_data = pd.concat(
            [kr_cell_volume_sub_data, kr_cell_volume_melt_data], ignore_index=True)
